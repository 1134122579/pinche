  ...
  onLoad: function () {
    ...
    wx.getLocation({
      success: function (res) {
        ...
        wx.request({
          url: 'https://api.map.baidu.com/reverse_geocoding/v3/?ak=gWsi6Fz4BewgvAxXcIv8oAnlrtBtEo62&location=' + latitude + ',' + longitude + '&output=json&pois=0',
          data: {},
          method: 'GET',
          header: {
